module Ckeditor
  ...
  module ViewHelper
    ...
    def ckeditor_textarea(object, field, options = {})
      ...
      # Changed because of depreciation warning in tests after moving from Rails 2.3.5 to 2.3.8
      ...
      client_config = '/client/javascripts/ckeditor/config.js'
      if File.exists?(File.join(RAILS_ROOT, 'public',client_config))
        ckeditor_options[:customConfig] = client_config
      end
