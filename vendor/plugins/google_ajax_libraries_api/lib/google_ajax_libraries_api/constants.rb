...
module RPH
  module Google
    module AjaxLibraries
      ...
      SUPPORTED_VERSIONS = {
        JQUERY        => ['1.2.3', '1.2.6', '1.3.0', '1.3.1', '1.3.2', '1.4.0', '1.4.1', '1.4.2', '1.4.3','1.4.4','1.5','1.5.1','1.5.2','1.6','1.6.1','1.6.2','1.6.3', '1.7','1.7.1'],
        JQUERYUI      => ['1.5.2', '1.5.3', '1.6.0', '1.7.0', '1.7.1', '1.7.2', '1.7.3', '1.8.0', '1.8.1', '1.8.2', '1.8.4', '1.8.5', '1.8.6', '1.8.7', '1.8.8', '1.8.9', '1.8.10', '1.8.11', '1.8.12', '1.8.13', '1.8.14', '1.8.15', '1.8.16'],
      ...
      GOOGLE_LIBRARIES = HashWithIndifferentAccess.new({
        JQUERY => OpenStruct.new(
          ...
          :default_version => '1.4.2' #Default to 1.4.2 so older sites don't break
        ),
        JQUERYUI => OpenStruct.new(
          ...
          :default_version => '1.8.0' #Default to 1.8.0 so older sites don't break
        ),
